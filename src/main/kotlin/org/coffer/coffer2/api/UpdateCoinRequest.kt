...
@Schema(description = "Request payload for updating an existing coin")
data class UpdateCoinRequest(
    ...
    @Schema(description = "Numista catalog type ID", example = "12345", maxLength = 50)
    ...
    fun toCommand(id: UUID) = UpdateCoinCommand(
        id = id,
        title = title,
